...
#pragma endregion CallbackFunctions
	...
	void SEGraphicsDevice::create_surface() { m_Window.create_window_surface(m_Instance, &m_Surface); }
	...
	void SEGraphicsDevice::populate_debug_messenger_create_info(
	...
	bool SEGraphicsDevice::check_validation_layer_support() {
		...
		if (result != VK_SUCCESS) {
			// Handle error, print message, and/or return false
	...
	VkFormat SEGraphicsDevice::find_supported_format(
	...
	void SEGraphicsDevice::create_vertex_buffer(
		VkDeviceSize size,
	...
	void SEGraphicsDevice::copy_buffer_to_image(
	...
	void SEGraphicsDevice::create_image_with_info(
